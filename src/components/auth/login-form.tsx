  ...
  return (
    <div className='w-full max-w-sm'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
        ...
        <Button
          type='submit'
          className='w-full bg-primary text-primary-foreground font-semibold py-5 rounded-lg hover:opacity-90 transition'
      ...
      <div className='space-y-3'>
        <Button
          type='button'
          variant='outline'
          className='w-full flex items-center justify-center gap-2 py-5 rounded-lg
        ...
        <Button
          type='button'
          className='w-full flex items-center justify-center gap-2 py-5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition'
        >
      ...
      <div className='mt-6 text-center'>
        ...
        <Link href={Routers.REGISTER} className='font-semibold text-blue-600 hover:underline'>
          Đăng ký ngay
        </Link>
      </div>
    </div>
