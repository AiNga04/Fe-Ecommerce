    ...
    <div className='space-y-6'>
      <div className='flex flex-col items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-100'>
        <div className='relative group'>
          ...
          <button
            className='absolute bottom-0 right-0 p-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-colors shadow-md z-10'
        ...
        <div className='mt-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-purple-100 text-purple-700 border border-purple-200'>
          Administrator
        </div>
        {isUploading && <p className='text-xs text-purple-500 mt-2'>Đang tải lên...</p>}
      </div>
